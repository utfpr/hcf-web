...
function removeTomboRepetido(queue) {
    /**
     * É necessário verificar se existem com tombos repetidos,
     * na qual utilizamos o for, pois precisamos do índice dele
     * para remover o elemento repetido da fila.
     * Além disso, isso acontece, pois um número de tombo pode ter
     * mais de um código de barra.
     */
