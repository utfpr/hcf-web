 ...
 * esperado.
 * @param {*} codBarra, na qual que será transformado no formato esperado,
 * com a quantidade de zeros correta.
 * @return string, com o código de barra no formato adequado, com a quantidade
 * de zeros correta.
 */
 ...
 * @param {*} listaCodBarra, lista de códigos de barras na qual será procurado a
 * existência do código de barras passado por parâmetro.
 ...
 * @param {*} listaCodBarra, lista de códigos de barras na qual será procurado a existência
 * do código de barras não existentes.
