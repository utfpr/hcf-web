...
class Conexao():
    ...
    def conexaoBancoFirebird(self, host, database, user, password):
...
def main():
    ...
    conexaoFirebird.conexaoBancoFirebird('localhost', '???', 'SYSDBA', 'masterkey')
    conexaoNova = Conexao()
    ...
    bancoFirebird = Database('???', conexaoFirebird.getCursor())
    ...
    print("---- CORRECAO LON - LAT CIDADES ... ----")
    ...
    print("---- COLETORES_COMPLEMENTARES ... ----")
    print("[DB_FIREBIRD] Obtendo dados da tabela: tombo")
    # GetconteudoTabela
